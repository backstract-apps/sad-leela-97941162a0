"""
Worker Supervisor for coll_bb41dfc9b26843b79d1e846650a0637a
...
class WorkerSupervisor:
  ...
  'max_memory_mb': 512,
  'name': 'Test Worker',
  'queue_name': 'test_queue_coll_bb41dfc9b26843b79d1e846650a0637a',
  'queue_resource_id': None,
  'queue_type': 'rabbitmq',
  'queue_use_localhost_defaults': True,
  'queues': [{'queue_name': 'test_queue_coll_bb41dfc9b26843b79d1e846650a0637a',
              'queue_resource_id': None,
              'queue_type': 'rabbitmq',
              'queue_use_localhost_defaults': True}],
  ...
  'worker_id': 'test_worker_coll_bb41dfc9b26843b79d1e846650a0637a'}]
